...
class RunConfigurationTest: KotlinCodeInsightTestCase() {
    ...
    fun testMainInTest() {
        ...
        ConfigLibraryUtil.configureKotlinRuntimeAndSdk(createResult.module, jdk(testRootDisposable) { mockJdk() })
    ...
    fun testUpdateOnClassRename() {
        ...
        ConfigLibraryUtil.configureKotlinRuntimeAndSdk(createModuleResult.module, jdk(testRootDisposable) { mockJdk() })
    ...
    fun testWithModuleForJdk6() {
        checkModuleInfoName(null, jdk(testRootDisposable) { mockJdk() })
    }

    fun testWithModuleForJdk9() {
        checkModuleInfoName("MAIN", jdk(testRootDisposable) { mockJdk9() })
    }

    fun testWithModuleForJdk9WithoutModuleInfo() {
        checkModuleInfoName(null, jdk(testRootDisposable) { mockJdk9() })
    }
    ...
    private fun doTest(configureRuntime: (Module, Sdk) -> Unit) {
        ...
        configureRuntime(createModuleResult.module, mockJdk())
